<template>
  <div class="homes">
    ...
    <div class="ogter">
      <div class="content">
        <div class="fltitle" v-text="$t('home.h8')">
          热门推荐
        </div>
        <div class="suggests">
        ...
        <div class="fltitle" v-text="$t('home.h10')">
          促销产品
        </div>
        <div class="suggests">
...
import { mallHomeBanner,mallHomeGoodsTypes,newsNewses,mallGoodsHotGoods,mallGoodsPromotionsActivity } from '@/request/api'
